...
class ContainsColor extends Matcher {
  final String color;
  final bool showStringProperties;

  ContainsColor(this.color, {this.showStringProperties = false});

  @override
  Description describe(Description description) {
    return description.add(
        '\'Color(${color.toLowerCase()})\' as value of a ColorProperty in Widget');
  }
  ...
  bool _checkNode(
    ...
    if (propertyType == 'ColorProperty') {
      foundMatch = description.contains(color.toLowerCase());
    }
